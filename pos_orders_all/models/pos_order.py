...
class pos_order(models.Model):
	...
	field_input_value = fields.Text(string="Custom Field")
	...
	@api.model
	def _date_order(self, ui_order):
		res = super(pos_order, self)._date_order(ui_order)
		res['field_input_value'] = ui_order('field_input_value')or False
		return res
