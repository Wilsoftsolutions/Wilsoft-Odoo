...
odoo Create Sales Order from Point of Sale Create SO from POS Create sales from Point of Sales
   ...
   Odoo point of sales invoice auto check auto invoice check in point of sales auto invoice check POS
    ...
    # 	'static/src/xml/delivery_date_so.xml',
    ...
    'assets': {
        'point_of_sale.assets': [
            ...
            "pos_orders_all/static/src/js/Popups/DeliveryDatePopup.js",
            ...
            "pos_orders_all/static/src/js/Screens/ControlButtons/DeliveryDate.js",
