odoo.define('payment_ebizcharge.upload_invoice', function (require) {
    "use strict";
    ...
    var CustomRendererTwo = WidgetViewer['CustomRenderer'].extend({
        ...
        _renderView: function () {
            return this._super.apply(this, arguments).then(() => {
                if(this.state.model === 'ebiz.list.invoice'){
                ...
                else if(this.state.model === 'ebiz.log.invoice'){
    ...
    fieldRegistry.add('upload_invoice', FieldVideoPreview);
