odoo.define('payment_ebizcharge.upload_products', function (require) {
    "use strict";
    ...
    var CustomRendererTwo = WidgetViewer['CustomRenderer'].extend({
        ...
        _renderView: function () {
            return this._super.apply(this, arguments).then(() => {
                if(this.state.model === 'list.of.products'){
                ...
                else if(this.state.model === 'logs.of.products'){
    ...
    fieldRegistry.add('upload_products', FieldVideoPreview);
