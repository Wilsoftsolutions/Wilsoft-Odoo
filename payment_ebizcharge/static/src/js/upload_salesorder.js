odoo.define('payment_ebizcharge.upload_salesorder', function (require) {
    "use strict";
    ...
    var CustomRendererTwo = WidgetViewer['CustomRenderer'].extend({
        ...
        _renderView: function () {
            return this._super.apply(this, arguments).then(() => {
                if(this.state.model === 'list.of.orders'){
                ...
                else if(this.state.model === 'logs.of.orders'){
    ...
    fieldRegistry.add('upload_salesorder', FieldVideoPreview);
