...
class CardExpiringSoon(models.TransientModel):
    ...
    # ('specific_days', 'Specific # of days'),
        ...
        try:
            ...
            if cards:
                ...
                for card in cards_lists:
                    name = card['CustomerInformation']['FirstName'] + ' ' + card['CustomerInformation']['LastName'] if card['CustomerInformation']['FirstName'] and  card['CustomerInformation']['LastName'] else card['CustomerInformation']['FirstName']
